...
{
    public class TypeExercise  //public = modifier
    {
        /// <summary>
        ...
        {
            return (nettopreis * steuerProdukt) ?? (nettopreis * steuerKategorie) ?? (nettopreis * 1.2M); //M = Money
            //if (steuerProdukt == null && steuerKategorie == null)
            //{
            //    steuerProdukt = (decimal?)1.2;
            //    return (decimal)(nettopreis * steuerProdukt);
            //}
            //if (steuerProdukt == null && steuerKategorie != null)
            //{
            //    return (decimal)(nettopreis * steuerKategorie);
            //}
            //return (nettopreis * steuerProdukt) ?? 0;
        ...
        {
            return (int)(wert / 8);
            //nein aber es passiert ein overflow
        }
